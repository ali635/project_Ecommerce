...
<div id="product_setting" class="tab-pane fade">
   ...
   <div class="form-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
      ...
      {!! Form::text('start_at',$product->start_at,['class'=>'form-control datepicker','placeholder'=>trans('admin.product_start_at'),'autocomplete'=>'off']) !!}
   </div>
   <div class="form-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
      {!! Form::label('end_at',trans('admin.product_end_at')) !!}
      {!! Form::text('end_at',$product->end_at,['class'=>'form-control datepicker','placeholder'=>trans('admin.product_end_at'),'autocomplete'=>'off']) !!}
   </div>
