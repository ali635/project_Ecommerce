...
<aside class="main-sidebar">
  ...
  <li class="treeview {{ active_menu('countries')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('countries')[1] }}">
      ...
      <li class=""><a href="{{ aurl('countries/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add1') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('cities')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
      ...
      <li class=""><a href="{{ aurl('cities/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add2') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('states')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('states')[1] }}">
      ...
      <li class=""><a href="{{ aurl('states/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add3') }}</a></li>
    </ul>
  </li>
  ...
  <li class="treeview {{ active_menu('departments')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('departments')[1] }}">
      ...
      <li class=""><a href="{{ aurl('departments/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add4') }}</a></li>
    </ul>
  </li>
  ...
  <li class="treeview {{ active_menu('trademarks')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('trademarks')[1] }}">
      ...
      <li class=""><a href="{{ aurl('trademarks/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add5') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('manufacturers')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('manufacturers')[1] }}">
      ...
      <li class=""><a href="{{ aurl('manufacturers/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add6') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('shipping')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('shipping')[1] }}">
      ...
      <li class=""><a href="{{ aurl('shipping/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add7') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('malls')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('malls')[1] }}">
      <li class=""><a href="{{ aurl('malls') }}"><i class="fa fa-paint-brush"></i> {{ trans('admin.malls') }}</a></li>
      <li class=""><a href="{{ aurl('malls/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add8') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('colors')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('colors')[1] }}">
      <li class=""><a href="{{ aurl('colors') }}"><i class="fa fa-building"></i> {{ trans('admin.colors') }}</a></li>
      <li class=""><a href="{{ aurl('colors/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add9') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('sizes')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('sizes')[1] }}">
      ...
      <li class=""><a href="{{ aurl('sizes/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add10') }}</a></li>
    </ul>
  </li>
  <li class="treeview {{ active_menu('weights')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('weights')[1] }}">
      ...
      <li class=""><a href="{{ aurl('weights/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add12') }}</a></li>
    </ul>
  </li>
  ...
  <li class="treeview {{ active_menu('products')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('products')[1] }}">
      ...
      <li class=""><a href="{{ aurl('products/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add11') }}</a></li>
    </ul>
  </li>

  <li class="treeview {{ active_menu('auctions')[0] }}">
    <a href="#">
      <i class="fa fa-tag"></i> <span>{{ trans('admin.auctions') }}</span>
      @if (lang()=='en')
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>     
    ...
    <ul class="treeview-menu" style="{{ active_menu('auctions')[1] }}">
      <li class=""><a href="{{ aurl('auctions') }}"><i class="fa fa-tag"></i> {{ trans('admin.auctions') }}</a></li>
      <li class=""><a href="{{ aurl('auctions/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.create_auctions') }}</a></li>
    </ul>
  </li>

   <li class="treeview {{ active_menu('bids')[0] }}">
    <a href="#">
      <i class="fa fa-tag"></i> <span>{{ trans('admin.bids') }}</span>
      @if (lang()=='en')
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>     
    ...
    <ul class="treeview-menu" style="{{ active_menu('bids')[1] }}">
